...
export function Sidebar({ className, collapsible = "none", ...props }: SidebarProps) {
  ...
  return (
    <div
      className={cn("flex flex-col h-full transition-all duration-300", isCollapsed ? "w-16" : "", className)}
      {...props}
    />
  )
}
...
export function SidebarTrigger({ className }: { className?: string }) {
  ...
  return (
    <Button variant="ghost" size="icon" onClick={toggleCollapse} className={className}>
